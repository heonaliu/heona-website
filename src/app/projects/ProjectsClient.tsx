            ...
            <AnimatePresence>
              {filtered.map((project, i) => (
                ...
                >
                  ...
                  >
                    {/* Thumbnail */}
                    <div className={`relative w-full h-28 rounded-2xl bg-gradient-to-br ${project.color} mb-5 overflow-hidden`}>
                      <div
                      ...
                      />
                      {statusBadge[project.status as keyof typeof statusBadge]}
                    </div>
          ...
          >
            ...
            >
              ...
              <div className={`relative w-full h-36 bg-gradient-to-br ${selected.color}
                               flex items-end p-6 rounded-t-[2rem]`}>
                <div
